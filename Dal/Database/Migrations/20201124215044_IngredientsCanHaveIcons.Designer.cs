...
namespace KitBook.Models.Database.Migrations
{
    ...
    [Migration("20201124215044_IngredientsCanHaveIcons")]
    partial class IngredientsCanHaveIcons
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessLogic.Models.Files.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("KitBook.Models.Database.Entities.Recipe", b =>
                {
                    ...
                    b.HasOne("BusinessLogic.Models.Files.File", "Thumbnail")
                        .WithMany()
            ...
            modelBuilder.Entity("KitBook.Models.Database.Entities.Stage", b =>
                {
                    b.HasOne("BusinessLogic.Models.Files.File", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("KitBook.Models.Database.Entities.Types.CookingType", b =>
                {
                    b.HasOne("BusinessLogic.Models.Files.File", "Icon")
                        .WithMany()
            ...
            modelBuilder.Entity("KitBook.Models.Database.Entities.User", b =>
                {
                    b.HasOne("BusinessLogic.Models.Files.File", "Avatar")
                        .WithOne()
                        .HasForeignKey("KitBook.Models.Database.Entities.User", "AvatarId");
